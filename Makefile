...
#    Updated: 2023/06/06 16:13:05 by jvan-hal      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
test_exit:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/exit.c source/cmd.c source/builtins/exit_test/exit_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
