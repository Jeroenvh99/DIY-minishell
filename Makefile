...
test_env:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/env.c source/env/env_append_val.c source/builtins/env_utils.c source/builtins/env_test/env_unittest.c lib/libft/libft.a && ./a.out
	rm a.out

test_exit:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/exit.c source/cmd.c source/env/env_append_val.c source/env/env.c source/builtins/exit_test/exit_unittest.c lib/libft/libft.a && ./a.out
	rm a.out

test_export:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/export.c source/env/env_append_val.c source/var_parse.c source/builtins/export_test/export_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
...
test_unset:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/unset.c source/env/env_append_val.c source/builtins/unset_test/unset_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
