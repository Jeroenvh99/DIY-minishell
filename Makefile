...
#    Updated: 2023/08/03 14:27:10 by jvan-hal      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
test_exit:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/exit.c source/minishell/cmd.c source/env/env_append_val.c source/env/env.c source/env/env_utils.c test/builtins/exit/exit_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
...
test_unset:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/unset.c source/env/env.c source/env/env_append_val.c source/env/env_unset.c source/env/env_utils.c test/builtins/unset/unset_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
...
test_msh_env:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/env/env.c source/env/env_utils.c source/env/env_search.c source/env/env_unset.c source/env/env_set.c source/env/env_append_val.c source/env/env_update.c source/var/var_parse.c test/msh/env/env_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
