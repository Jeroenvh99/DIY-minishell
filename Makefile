...
#    Updated: 2023/08/11 10:37:30 by jvan-hal      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
test_unset:
	$(MAKE) -j -C lib/libft
	cc $(CFLAGS) -lcriterion source/builtins/unset.c source/env/env.c source/env/env_unset.c source/env/env_basevars.c source/env/env_utils.c source/env/env_search.c source/env/env_set.c source/env/env_set_main.c source/env/env_basevars.c source/var/var_parse.c source/var/var_utils.c test/builtins/unset/unset_unittest.c lib/libft/libft.a && ./a.out
	rm a.out
